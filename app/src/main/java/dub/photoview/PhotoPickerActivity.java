...
import bean.Photo;
import bean.PhotoFolder;
import utlis.LogUtils;
import utlis.OtherUtils;
import utlis.PhotoUtils;
...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!OtherUtils.isExternalStorageAvailable()) {
            Toast toast= Toast.makeText(this, "No SD card!", Toast.LENGTH_SHORT);
    ...
    private void getPhotosSuccess() {
        ...
        mPhotoNumTV.setText(OtherUtils.formatResourceString(context,
                R.string.photos_num, mPhotoLists.size()));

        mPhotoAdapter = new PhotoAdapter(context, mPhotoLists);
    ...
    public void onPhotoClick() {
        ...
        if(list != null && list.size()>0) {
            ...
            mCommitBtn.setText(OtherUtils.formatResourceString(context,
